...
function getRoleContent(role: string, displayName: string) {
  const roleMap: Record<string, { subject: string; greeting: string; intro: string; features: string[]; ctaText: string; ctaLink: string }> = {
    patient: {
    ...
    doctor: {
      ...
      intro: "Your doctor account on MediCare+ is now active. You can start managing your patients and appointments.",
      features: [
        "📋 Manage your patient queue and appointments",
        "💊 Write and send digital prescriptions",
        "📊 View patient history and test reports",
        "⚙️ Customize your schedule and break times",
      ],
    ...
    pa: {
      ...
      greeting: `Hello ${displayName}! 👋`,
      intro: "Your Personal Assistant account is now active. You can assist doctors with managing their patients.",
      features: [
        "📋 Manage appointments for assigned doctors",
        "🩺 Enter patient vitals and details",
        "👥 Add walk-in patients to the queue",
        "📊 View patient records and test reports",
      ],
    ...
    admin: {
      ...
      greeting: `Hello ${displayName}! 🔑`,
      intro: "Your admin account is now active. You have full access to manage the MediCare+ platform.",
      features: [
    ...
    pharmacy: {
      ...
      greeting: `Hello ${displayName}! 💊`,
      intro: "Your pharmacy account on MediCare+ is now active. Start managing your inventory and sales.",
      features: [

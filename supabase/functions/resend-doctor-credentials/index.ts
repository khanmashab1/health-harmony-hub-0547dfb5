          ...
          html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
              <div style="background: linear-gradient(135deg, #14b8a6, #0d9488); padding: 30px; border-radius: 12px 12px 0 0; text-align: center;">
                <h1 style="color: white; margin: 0; font-size: 28px;">Credentials Reset</h1>
              </div>
              <div style="background: #f8fafc; padding: 30px; border-radius: 0 0 12px 12px; border: 1px solid #e2e8f0; border-top: none;">
                ...
                <p style="font-size: 16px; color: #334155; margin-bottom: 20px;">
                  Your login credentials for <strong>${org.name}</strong> have been reset by an administrator.
                </p>
                
                <div style="background: white; border: 2px solid #14b8a6; border-radius: 8px; padding: 20px; margin: 25px 0;">
                  <h3 style="color: #0f766e; margin-top: 0; margin-bottom: 15px;">Your New Login Credentials</h3>
                  <p style="margin: 8px 0; font-size: 15px;">
                    <strong>Email:</strong> <span style="color: #0d9488;">${doctorEmail}</span>
                  </p>
                  <p style="margin: 8px 0; font-size: 15px;">
                    <strong>Temporary Password:</strong> <span style="color: #0d9488;">${newPassword}</span>
                  </p>
                </div>
                
                <p style="font-size: 14px; color: #64748b; margin-bottom: 20px;">
                  <strong>⚠️ Important:</strong> You will be required to change your password when you log in.
                </p>
                ...
                <p style="font-size: 13px; color: #94a3b8; text-align: center; margin: 0;">
                  If you didn't request this reset, please contact your organization administrator immediately.
                </p>
              </div>
            </div>
          `,

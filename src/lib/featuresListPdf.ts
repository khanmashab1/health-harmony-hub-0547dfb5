...
export function downloadFeaturesListPDF() {
  ...
  doc.text("80+ Features • 14 Categories • 4 User Roles", pageWidth / 2, 175, { align: "center" });
  ...
  doc.setTextColor(60);
  const stats = [
    "Total Features: 80+  •  User Roles: 4  •  Edge Functions: 18+",
    "Database Tables: 25+  •  AI Features: 10  •  Email Types: 12",
    "SEO Pages: 10  •  Cron Jobs: 3",
  ];
  stats.forEach((s, i) => {
